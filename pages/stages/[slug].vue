  ...
  <article class="mx-auto max-w-4xl space-y-8">
    ...
    <section class="rounded-[2rem] bg-white p-8 shadow-float">
      <div class="flex flex-wrap items-center gap-3">
        <span class="rounded-full bg-mint px-3 py-1 text-xs font-semibold text-pine">{{ item.category }}</span>
    ...
    <section class="rounded-[2rem] bg-white p-8 shadow-float">
      <h2 class="text-2xl font-semibold text-pine">阶段导读</h2>
    ...
    <section class="rounded-[2rem] bg-white p-8 shadow-float">
      <h2 class="text-2xl font-semibold text-pine">这一阶段建议重点关注</h2>
